#!/bin/bash
#SBATCH --job-name=WebLINXCandidatesReranking_BAAI_bge_m3
#SBATCH --time=09:15:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH -p defq
#SBATCH --gres=gpu:1
#SBATCH --output=logs/WebLINXCandidatesReranking_BAAI_bge_m3-%j.out
...
python python_tasks/WebLINXCandidatesReranking___BAAI_bge_m3.py
