#!/bin/bash
#SBATCH --job-name=STS17Crosslingual_intfloat_multilingual_e5_large_instruct
#SBATCH --time=12:15:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH -p defq
#SBATCH --gres=gpu:1
#SBATCH --output=logs/STS17Crosslingual_intfloat_multilingual_e5_large_instruct-%j.out
...
python python_tasks/STS17Crosslingual___intfloat_multilingual_e5_large_instruct.py
