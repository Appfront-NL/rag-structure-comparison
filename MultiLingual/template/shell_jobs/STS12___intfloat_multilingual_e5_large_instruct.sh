#!/bin/bash
#SBATCH --job-name=STS12_intfloat_multilingual_e5_large_instruct
#SBATCH --time=09:15:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH -p defq
#SBATCH --gres=gpu:1
#SBATCH --output=logs/STS12_intfloat_multilingual_e5_large_instruct-%j.out
...
python python_tasks/STS12___intfloat_multilingual_e5_large_instruct.py
