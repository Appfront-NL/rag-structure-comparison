#!/bin/bash
#SBATCH --job-name=STS12STS12STS_HIT_TMG_KaLM_embedding_multilingual_mini_v1
#SBATCH --time=12:15:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH -p defq
#SBATCH --gres=gpu:1
#SBATCH --output=logs/STS12STS12STS_HIT_TMG_KaLM_embedding_multilingual_mini_v1-%j.out
...
python python_tasks/STS12STS12STS___HIT_TMG_KaLM_embedding_multilingual_mini_v1.py
