#!/bin/bash
#SBATCH --job-name=STS17Crosslingual_HIT_TMG_KaLM_embedding_multilingual_mini_v1
#SBATCH --time=09:15:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH -p defq
#SBATCH --gres=gpu:1
#SBATCH --output=logs/STS17Crosslingual_HIT_TMG_KaLM_embedding_multilingual_mini_v1-%j.out
