...
#SBATCH -p defq
#SBATCH --gres=gpu:1
#SBATCH --output=logs/WikipediaRerankingMultilingual_intfloat_multilingual_e5_large_instruct-%j.out
...
python python_tasks/WikipediaRerankingMultilingual___intfloat_multilingual_e5_large_instruct.py
