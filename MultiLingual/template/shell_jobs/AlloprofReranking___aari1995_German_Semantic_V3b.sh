#!/bin/bash
#SBATCH --job-name=AlloprofReranking_aari1995_German_Semantic_V3b
#SBATCH --time=12:15:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH -p defq
#SBATCH --gres=gpu:1
#SBATCH --output=logs/AlloprofReranking_aari1995_German_Semantic_V3b-%j.out
...
python python_tasks/AlloprofReranking___aari1995_German_Semantic_V3b.py
